 ...
 */
/**
 * @brief Alias template to remove const, volatile, and reference qualifiers
 * from a type.
 *
 * This alias template removes const, volatile, and reference qualifiers from
 * the type T.
 *
 ...
 *
 * This alias template removes const, volatile, and reference qualifiers from
 * the type T. It is equivalent to remove_cvref<T>::type.
 *
 * @tparam T The type to remove qualifiers from.
 */
 ...
 */
/**
 * @brief Invokes a series of functions on a copy of the given argument and
 * returns the modified copy.
 *
 * This function template takes an argument by reference, creates a copy of it,
 * and then invokes each of the provided functions on the copy. The modified
 * copy is then returned.
 *
 ...
 *
 * This function template takes an argument by reference and returns it without
 * any modifications if no functions are provided.
 *
 * @tparam T The type of the argument.
